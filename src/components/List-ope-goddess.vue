    ...
    <div>
      <ul style="margin-bottom:100px">
        <li v-for="(item,idx) in data" :key="item.ID" @click="goodsT(item.Name,item.Brand)">
          ...
          <div class="listImg">
            <img v-lazy="geturl(item.Name)" alt />
          </div>
          ...
          <div class="details">
            ...
            <p class="price">
              ...
              <img class="shopcart" src="../assets/imgs/list-cart.png" alt @click.stop="addtocar(idx)" />
            </p>
          </div>
        </li>
      </ul>
      ...
      async addtocar(idx) {
        ...
        if (username && token) {
          ...
          if (result.data.status == 1) {
            ...
            await this.postdata("http://118.31.77.168:3001/setshopcart", {
              msg,
              username
            });
          }
